...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_loss, train_acc, flops = train(trainloader, model, criterion, optimizer, epoch, use_cuda)
        test_loss, test_acc = test(testloader, model, criterion, epoch, use_cuda)

        # append logger file
        logger.append([flops, state['lr'], train_loss, test_loss, train_acc, test_acc])
...
def train(trainloader, model, criterion, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        # print("batch:",batch_idx,"prec1=",prec1.item(),"prec5=",prec5.item())
        ...
        if batch_idx == 0:
            flops = model.compute_average_flops_cost()/1e9/2
            print("Gflops = ", flops)
    ...
    bar.finish()
    # input()
    return (losses.avg, top1.avg, flops)
